...
const planetsData = [
  ...
  },
  {
    ...
    moons: [
      { name: "Io", radius: 0.2, distance: 3, texture: "./textures/io.jpg", orbitSpeed: 0.02 },
      { name: "Europa", radius: 0.18, distance: 4, texture: "./textures/europa.jpg", orbitSpeed: 0.018 },
      { name: "Ganymede", radius: 0.3, distance: 5, texture: "./textures/ganymede.jpg", orbitSpeed: 0.016 },
      { name: "Callisto", radius: 0.25, distance: 6, texture: "./textures/callisto.jpg", orbitSpeed: 0.015 },
    ],
    orbitSpeed: 0.005,
  },
  {
    ...
    moons: [
      { name: "Titan", radius: 0.25, distance: 4, texture: "./textures/titan.jpg", orbitSpeed: 0.017 },
      { name: "Enceladus", radius: 0.1, distance: 3, texture: "./textures/enceladus.jpg", orbitSpeed: 0.02 },
    ],
    orbitSpeed: 0.004,
  },
  {
    ...
    moons: [
      { name: "Miranda", radius: 0.1, distance: 2, texture: "./textures/miranda.jpg", orbitSpeed: 0.02 },
      { name: "Ariel", radius: 0.15, distance: 3, texture: "./textures/ariel.jpg", orbitSpeed: 0.018 },
    ],
    orbitSpeed: 0.003,
  },
  {
    ...
    moons: [
      { name: "Triton", radius: 0.2, distance: 3, texture: "./textures/triton.jpg", orbitSpeed: 0.02 },
    ],
    orbitSpeed: 0.002,
  },
];
